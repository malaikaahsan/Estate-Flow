...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 lg:h-screen lg:sticky lg:top-0 flex h-screen w-[290px] flex-col bg-white border-r border-[#E2E8F0] shadow-2xl transition-all duration-300 ease-in-out
