...
const reviews = [
  {
    ...
    rating: 5,
    date: "12 Jul 2026",
    comment: "Amazing property with great location and excellent facilities.",
  },
  {
    id: 2,
    name: "Sara Ahmed",
    ...
    rating: 4,
    date: "20 Jun 2026",
    comment: "Very spacious and clean. The neighborhood is peaceful.",
  },
  {
    id: 3,
    name: "Ahmed Raza",
    ...
    <div className="relative overflow-hidden rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-sm">
      ...
      <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3 rounded-xl bg-[#F8FAFC] px-4 py-2 border border-[#E2E8F0]">
          ...
          <span className="font-semibold text-[#0F172A]">{average}</span>
